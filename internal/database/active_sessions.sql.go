...
const removeAllSessions = `-- name: RemoveAllSessions :exec
DELETE FROM active_sessions
`

func (q *Queries) RemoveAllSessions(ctx context.Context) error {
	_, err := q.db.ExecContext(ctx, removeAllSessions)
	return err
}
